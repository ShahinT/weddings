...
const Login = () => {
  ...
  const emailModelHandler = (value: string) => {
    setEmailModel(value);
  }
  const passwordModelHandler = (value: string) => {
              ...
              <div className="pb-6 pr-6 pl-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={(e) => signinHandler(e)}>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    Don’t have an account yet? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign
                    up</a>
                  </p>
                </form>
              </div>
