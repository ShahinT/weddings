...
const BottomNavigationAdmin = () => {
  ...
  const [navButtons] = useState<NavButton[]>([
    ...
    {id: 3, icon: <IconAddGuest size="6" />, to: `/admin/${eventId}/add-guest`},
  ...
  return (
    <div className="fixed z-30 w-full h-14 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
